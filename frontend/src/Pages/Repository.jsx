import { ArrowLeft, CircleAlert, Files, Folder, GitFork, Plus, Star, Eye } from "lucide-react";
import Header from "../components/Header";
import Footer from "../components/Footer";
import styles from "../Pages/Repository.module.css";
            ...
            <div className={styles["main-section"]}>
                <div className={styles["repo-profile-wrapper"]}>
                    ...
                    <div className={styles["repo-description-wrapper"]}>
                        ...
                        <div>
                            <button className="view-github-btn">
                ...
                <div className={styles["repo-content-wrapper"]}>
                    <div className={styles["repo-files"]}>
                        <div className={styles["header-file-label"]}>
                            <button className={styles["file-btn"]}>
                                File
                            </button>
                            <button className={styles["commit-btn"]}>
                                Commit
                            </button>
                        </div>
                        <div className={styles["files"]}>
                            ...
                            <di className={styles["opened-file-wrapper"]}>
                    ...
                    <div className={styles["repo-stats-wrapper"]}>
                        ...
                        <div className={styles["languages-repo"]}>
                            ...
                            <div className={styles["languages-wrapper"]}>
                                <div className={styles["languages-bar"]}></div>
